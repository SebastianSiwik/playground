...
namespace BicycleService.Api.Middlewares
{
    public class ErrorHandlerMiddleware
    {
        ...
        private Dictionary<Func<Exception, bool>, Func<Exception, (string, int)>> _exceptionDictionary = new Dictionary<Func<Exception, bool>, Func<Exception, (string, int)>> { };
    }
}
